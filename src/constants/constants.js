...
export const CANCEL_GET_EVENTS = 'CANCEL_GET_EVENTS';

export const CLEAR_SEARCH_STATE = 'CLEAR_SEARCH_STATE';
export const SET_LAST_REF_KEY = 'SET_LAST_REF_KEY';
export const CLEAR_SEARCH_STATE_EVENTS = 'CLEAR_SEARCH_STATE_EVENTS';
export const SET_LAST_REF_KEY_EVENTS = 'SET_LAST_REF_KEY_EVENTS';
...
export const SET_TEXT_FILTER_EVENTS = 'SET_TEXT_FILTER_EVENTS';
export const SET_BRAND_FILTER_EVENTS = 'SET_BRAND_FILTER_EVENTS';
export const RESET_FILTER_EVENTS = 'RESET_FILTER_EVENTS';
export const APPLY_FILTER_EVENTS = 'APPLY_FILTER_EVENTS';
export const CLEAR_RECENT_SEARCH_EVENTS = 'CLEAR_RECENT_SEARCH_EVENTS';
export const REMOVE_SELECTED_RECENT_EVENTS = 'REMOVE_SELECTED_RECENT_EVENTS';
